      ...
      if (extend) {
        ...
        if (classBody) {
          ...
          if (funcDec) {
            ...
            path.parent.node.comments = path.parent.node.comments || [];
            path.parent.node.comments.push(j.line('TODO: intl-template-transform text must be inside ember class or inside a function with parameter intl, container, owner or intl can be defined inside the function.', true, false));
            onSomethingChanged();
          }
        }
      }
