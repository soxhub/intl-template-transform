        ...
        if (classBody) {
          ...
          if (funcDec) {
            ...
            if (argumentsChanged) {
              ...
              path.parent.node.comments.push(j.line('intl-template-transform TODO: function must have parameter intl, container, owner or intl can be defined inside function.', true, false));
              onSomethingChanged();
            ...
            path.parent.node.comments = path.parent.node.comments || [];
            path.parent.node.comments.push(j.line('intl-template-transform TODO: text must be inside ember class or inside a function with parameter intl, container, owner or intl can be defined inside the function.', true, false));
            onSomethingChanged();
          }
        }
      }
