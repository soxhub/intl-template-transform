let componentsToTranslate = [
  ...
  },
  {
    ...
    arguments: ['@placeholder', '@emptyOptionPlaceholder'],
  },
  {
  ...
  },
  {
    ...
    arguments: ['@totalTitle'],
  },
  {
    name: 'OwnerDashboard::OverviewPanel::Field',
    arguments: ['@tooltipTitle'],
  },
  {
    name: 'PowerSelect',
    arguments: ['@placeholder', '@searchPlaceholder'],
  },
  {
    name: 'PowerSelectMultiple',
    arguments: ['@searchPlaceholder', '@placeholder'],
  },
  {
  ...
  },
  {
    ...
    arguments: ['@linkLabel', '@buttonLabel', '@label'],
  },
  {
...
module.exports = function getArgumentsToTranslate(node) {
  ...
  if (components.length) {
    let argumentsToTranslate = node.attributes.filter((a) =>
      components.find((c) => c.arguments.includes(a.name))
    );
